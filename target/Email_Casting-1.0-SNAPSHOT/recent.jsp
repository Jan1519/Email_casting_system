...
//            final String password = "dummy2263!";// provide password
            ...
            Message messages[] = inbox.search(new FlagTerm(
                    new Flags(Flags.Flag.RECENT), true));
        %>
        <center><br>Trash Mail</center><br><br><br>
        ...
        <div class="panel">
            ...
            <br><br><center>
                ...
                <div class="content">
                    <form action="deleteSEENMailServlet">
        ...
        <%}
                ...
                out.println("<br><br><br><br><br><center style = 'color:red'>No seen Mail</center><br><br><br><br><br><br>");
