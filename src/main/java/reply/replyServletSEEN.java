...
@WebServlet(name = "replyServletSEEN", urlPatterns = {"/replyServletSEEN"})
public class replyServletSEEN extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        obj.reply(content, emailNo, username, password);
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<h1><br><br><br><br><br><br><center style='color:green'>reply SuccessFully</center></h1>");
        out.println("<h1><br><br><br><br><br>" + content + "</h1>");
