...
public class EmpDao {  
    ...
    public static Connection getConnection(){  
        ...
        {  
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/emailcasting","root","0496");  
        }
    ...
    public static int save(Emp e){  
        ...
        try{  
            ...
            ("insert into userdata(Id,Name,Email,Password,Country) values (?,?,?,?,?)");  
            ps.setInt(1,e.getId());
    ...
    public static int update(Emp e){  
        ...
        try{  
            Connection con=EmpDao.getConnection();  
            PreparedStatement ps=con.prepareStatement(  
                         "update userdata set Name=?,Email=?,Password=?,Country=? where Id=?");  
