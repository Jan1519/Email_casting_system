...
public class ViewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        out.println("<br><br><a href=\"manageUserAdmin.jsp\" style=\"float: right; text-decoration: none; border: 1px solid black; "
                + "padding: 15px; background-color: green; color: #FFF; font-size: 20px\">Add New Candidate</a>\n" +"<br><br><br>");
        ...
        out.print("<tr><td>"+e.getId()+"</td><td>"+e.getName()+"</td><td>"+e.getEmail()+"</td><td>"
                +e.getPassword()+"</td><td>"+e.getCountry()+"</td><td><a href='EditServlet?Id="+e.getId()+"'>edit</a></td><td>"
