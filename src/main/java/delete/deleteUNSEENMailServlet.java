...
@WebServlet(name = "deleteUNSEENMailServlet", urlPatterns = {"/deleteUNSEENMailServlet"})
public class deleteUNSEENMailServlet extends HttpServlet {
...
//            obj.deleteEmail(deleteemailNo);
            ...
            DeleteMailUNSEEN sample = new DeleteMailUNSEEN();
