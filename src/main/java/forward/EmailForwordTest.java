...
public class EmailForwordTest {
        public String forward(String repliedText, String eno, String forwardmail,final String username,final String password) {
        String replySuccess = "";
...
//        final String password = "dummy2263!";
        ...
        try {
            ...
            message2.addRecipient(Message.RecipientType.TO, new InternetAddress(forwardmail));
